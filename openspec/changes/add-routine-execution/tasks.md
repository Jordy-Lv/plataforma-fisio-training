...
- [ ] 4.1 Iniciar sesión de entrenamiento y persistir cada marca en el momento; verificar que cerrar la aplicación no pierde lo marcado
- [ ] 4.2 Registrar series, repeticiones y peso reales, distinguibles de los prescritos
- [ ] 4.3 Marcar como saltado exigiendo motivo en el mismo paso: nivel de dolor, zona y observación
- [ ] 4.4 Registrar esfuerzo percibido y sustitución de ejercicio
- [ ] 4.5 Validar rango de dolor 0–10 y vocabulario de zonas en base de datos y con Zod; verificar que ambos rechazan valores inválidos
- [ ] 4.6 Cerrar la sesión y verificar que el profesional a cargo la ve

## 5. Alertas

- [ ] 5.1 Crear la tabla de umbrales configurables con sus valores por defecto
- [ ] 5.2 Evaluar y generar alertas al cerrar la sesión: dolor persistente y ejercicios saltados
- [ ] 5.3 Dirigir la alerta a todos los profesionales con asignación vigente y al administrador
- [ ] 5.4 Bandeja de alertas del profesional con contexto y severidad; marcar como leída
- [ ] 5.5 Bandeja del administrador con todas las alertas
- [ ] 5.6 Verificar por API que un paciente no lee alertas y que un profesional no asignado no ve las de ese paciente
- [ ] 5.7 Verificar el camino 5 del plan de verificación de extremo a extremo
