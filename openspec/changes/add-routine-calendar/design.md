...
- Para profesionales y administradores, pulsar un día vacío válido lleva al formulario de programación con esa fecha. Si el paciente no tiene días de rutina activa, abre la creación/asignación existente con contexto de fecha y regreso al calendario. Los pacientes consultan el calendario y conservan la ejecución y el registro existentes; no reciben permisos de programación.
...
- La edición de ejercicios conserva el contexto del calendario en los enlaces y los campos ocultos de búsqueda. Los filtros del catálogo no alteran la fecha/vista de regreso. Se reutiliza el buscador único y permanente de `main`; salir del día o de la sustitución mantiene el contexto sin ocultar ese buscador. Se conserva la confirmación existente al reemplazar una rutina activa.
