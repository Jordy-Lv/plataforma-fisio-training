...
/*
  Esqueleto de los tamizajes de un paciente: las pestañas de la ficha, el
  historial de mediciones a la izquierda y el formulario de un tamizaje nuevo
  a la derecha. El grupo `(progress)` dibuja tres tarjetas apiladas, sin las
  pestañas ni las dos columnas.
...
export default function Loading() {
  return (
    <div
      role="status"
      aria-label="Cargando los tamizajes del paciente"
